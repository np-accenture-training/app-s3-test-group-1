...
BUCKET_NAME = os.environ.get("BUCKET_GRUPO_1_BUCKET_NAME", "")
BUCKET_REGION = os.environ.get("BUCKET_GRUPO_1_BUCKET_REGION", "us-east-1")
AWS_ACCESS_KEY_ID = os.environ.get("BUCKET_GRUPO_1_ACCESS_KEY_ID", "")
AWS_SECRET_ACCESS_KEY = os.environ.get("BUCKET_GRUPO_1_SECRET_ACCESS_KEY", "")
...
def health():
    return jsonify({
        ...
        "bucket_arn": os.environ.get("BUCKET_GRUPO_1_BUCKET_ARN", ""),
